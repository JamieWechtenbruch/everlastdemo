...
const numbers = [
  ...
  { value: "120.000+", label: "Anrufe / Monat", icon: PhoneIcon },
  { value: "68%", label: "Conversion Rate", icon: TrendingUp },
    ...
    <div className="relative min-h-screen bg-white text-stone-900 font-sans overflow-x-hidden flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-stone-100">
        <div className="flex items-center justify-between px-6 lg:px-12 py-4 w-full max-w-[1400px] mx-auto">
          <div className="flex items-center gap-2.5 font-bold text-2xl tracking-tighter text-stone-900">
            <div className="w-8 h-8 bg-gradient-to-br from-orange-500 to-amber-500 rounded-lg flex items-center justify-center text-white text-sm font-black">
              K
            </div>
            Kreativstrom
          </div>
      ...
      {/* ── Hero ────────────────────────────────────── */}
      <section className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 pt-16 pb-20 flex-1">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center w-full">
          <div className="flex flex-col items-start max-w-2xl">
            <div className="text-orange-600 font-bold tracking-wide uppercase text-sm mb-6 flex items-center gap-2">
              ...
              KI-Projektmanagement für Agenturen
            </div>
            ...
            <p className="text-lg text-stone-600 mb-10 font-medium leading-relaxed max-w-xl">
              Kreativstrom ist die KI-Projektmanagement-Plattform, die Agenturen und Marketing-Teams hilft, Projekte schneller abzuliefern. Automatisierte Briefings, smarte Timelines und Echtzeit-Reporting — alles in einer SaaS-Lösung. Sprich jetzt mit Anna, um mehr zu erfahren.
            </p>
      ...
      <footer className="py-8 border-t border-stone-200/60">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-sm font-bold text-stone-400">
            &copy; 2026 Kreativstrom GmbH
          </div>
          <div className="text-xs text-stone-400">
            Torstraße 77, 10119 Berlin &middot; info@kreativstrom.de &middot; +49 30 12345678
          </div>
        </div>
      </footer>
    </div>
