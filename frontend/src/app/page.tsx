...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-white text-stone-900 font-sans overflow-hidden flex flex-col">
      ...
      {/* Background Vector Line (1:1 from Nuonix) */}
      ...
      {/* Hero Section (1:1 Nuonix Layout) */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center w-full">
          ...
          <div className="flex flex-col items-start max-w-2xl">
            ...
            <div className="flex items-center gap-4 mb-14">
              <Link 
                href="/dashboard"
                className="px-8 py-4 rounded-full bg-black text-white font-bold hover:bg-stone-800 transition-all flex items-center gap-3 text-lg"
              >
                KI-Agenten anrufen
          ...
          {/* Right Column - Nuonix Robot Image */}
          <div className="relative w-full flex justify-center lg:justify-end">
            ...
            />
            {/* Floating Elements (Nuonix style) */}
            <img 
